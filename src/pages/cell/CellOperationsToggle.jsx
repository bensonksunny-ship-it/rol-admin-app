/**
 * Sub-toggle rendered at the top of the Operations tab on the Cell page.
 * Purely presentational: the hub owns opsSubTab state and renders the real content
 * (team / planning / budget) based on it.
 */
